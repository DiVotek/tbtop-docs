...
| `url_import.enabled` | `true` | Whether URL import is accepted. When `false` the input still shows in the dialog, and an import returns a 422 'URL import is disabled.' |
